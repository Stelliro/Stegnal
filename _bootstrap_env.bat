...
REM
REM  Guarantees a WORKING .venv (Python 3.12) with the stegnal
...
"%PYEXE%" -c "import stegnal" >nul 2>nul
...
:install_pkg
echo [SYSTEM] Installing Stegnal + dependencies ^(first run; may take a minute^)...
